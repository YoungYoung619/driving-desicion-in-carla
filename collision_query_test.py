...
if __name__ == '__main__':
    ...
    spawn_vehicles(world, number=10)
    ...
    ## start check
    t1 = Thread(target=check_whether_respawn_actors, args=(world, vehicles))
    t1.daemon = True
    t1.start()

    t2 = Thread(target=make_vehicle_random_drive, args=(vehicles,))
    t2.daemon = True
    t2.start()
