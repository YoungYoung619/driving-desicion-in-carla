...
def mobilenetv2(inputs, is_training):
    ...
    with tf.variable_scope('mobilenetv2'):
        ...
        net = res_block(net, exp, 64, 2, is_training, name='res7_1')  # size/32
        endPoints['layer_15'] = net
        net = res_block(net, exp, 48, 1, is_training, name='res7_2')
        endPoints['layer_16'] = net
        net = res_block(net, exp, 36, 1, is_training, name='res7_3')
...
if __name__ == '__main__':
    ...
    out = tf.reshape(bp(state_action, is_training=True), [-1])
    pass
